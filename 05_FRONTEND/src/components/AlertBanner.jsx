  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        exit={{ opacity: 0, y: -24 }}
        className="bg-[#FAFAFA] border-b border-[#E11D48]/30 px-8 py-3 flex items-center justify-between z-40 sticky top-[73px]"
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-neutral-800 text-sm ml-4">
