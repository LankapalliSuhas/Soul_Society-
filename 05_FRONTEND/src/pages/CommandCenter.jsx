        ...
        >
          <div className="col-span-12 lg:col-span-8 flex flex-col gap-8">
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="p-8 border border-white/10 bg-[#111111]/40 backdrop-blur-sm rounded-lg flex flex-col justify-between">
                <h3 className="text-white/60 text-xs tracking-widest uppercase mb-4">Critical Inventory</h3>
                <div className="text-5xl font-light tracking-tighter text-[#E11D48] drop-shadow-[0_0_8px_rgba(225,29,72,0.8)]">
                  {data.inventory.filter(i => i.status?.toLowerCase() === 'critical').length}
                </div>
                <div className="text-sm text-white/40 mt-2">SKUs require immediate restock</div>
              </div>
            </div>

            <div className="flex-1 border border-white/10 bg-[#050505]/60 backdrop-blur-md rounded-lg p-8">
              <div className="flex justify-between items-end mb-8">
                <div>
                  <h2 className="text-2xl font-light tracking-wide text-white/90 uppercase">Checkout Flow</h2>
                  <p className="text-sm text-white/40 mt-1">Live automated queue surveillance</p>
                </div>
              </div>
          ...
          <div className="col-span-12 lg:col-span-4 border border-white/10 bg-[#050505]/80 backdrop-blur-md rounded-lg p-6 flex flex-col">
            <div className="mb-6 flex justify-between items-center">
              <h2 className="text-lg font-light tracking-wide text-white/90 uppercase">Sensor Feed</h2>
