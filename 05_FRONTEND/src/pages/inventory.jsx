...
export default function Inventory() {
  ...
  return (
    ...
    >
      <div>
        <h1 className="text-3xl font-light tracking-wide text-white/90 uppercase">Curated Origins</h1>
        <p className="text-white/60 mt-2">Hand-selected produce, artisan bakes, and reserves.</p>
      </div>

      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-8 bg-[#111111]/40 border border-white/10 rounded-lg p-1">
          <StockTable inventory={inventory} />
        </div>

        <div className="col-span-12 lg:col-span-4 flex flex-col gap-8">
          <div className="bg-[#111111]/40 border border-white/10 rounded-lg p-6">
            <h3 className="text-white/60 text-xs tracking-widest uppercase mb-6">Stock Aggregates</h3>
